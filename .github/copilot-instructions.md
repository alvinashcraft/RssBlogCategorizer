...
- **Never commit directly to main**: Do not create commits on the `main` branch. Create or use a feature branch and commit there so changes can go through a pull request.
